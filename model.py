...
# TODO: Check visual similarity predictions
import os
import time
import random
import shutil
...
class Autoencoder(object):
    ...
    def __init__(self, opt):
        ...
        generate_code_dataset = self.dataset.create_result_dataset(set_name='val', repeat=True) #### FIGURE OUT WHETHER THIS IS VIABLE
